  ...
  const server = new McpServer(
    { name: "chronicle", version: options.version ?? "0.1.0" },
    {
      instructions: [
        ...
        "",
        "When the developer says to remember, record, note, always use, never use, prefer, avoid",
        "or otherwise gives a durable project rule, decision or convention, use Chronicle rather",
        "than private assistant memory. Call knowledge_propose so the developer can review it before",
        "it becomes shared project knowledge.",
        "",
  ...
  server.registerTool(
    "knowledge_propose",
    {
      ...
      description: [
        ...
        "edits or rejects.",
        "",
        "Use this instead of private assistant memory when the developer asks you to remember",
        "a durable project rule, decision, convention or preference, including wording such as",
        "\"remember to\", \"always use\", \"never use\", \"prefer\" or \"avoid\".",
        "",
